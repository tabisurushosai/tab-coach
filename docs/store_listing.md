...
| 5 | プロモアセットが解像度通り | `assets/icon_128.png` (128x128) / `screenshot_*.png` (1280x800) / `promo_small.png` (440x280) / `promo_marquee.png` (1400x560) |
...
| アイコン (128x128 PNG) | — | `assets/icon_128.png` |
| スクリーンショット (1280x800 PNG, 1〜5 枚) | — | `assets/screenshot_*.png` 全枚 |
